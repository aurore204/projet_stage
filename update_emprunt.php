...
<head>
    ...
    try{
        ...
        $sql = "SELECT emprunt.id_emprunt,emprunteur.matricule_emprunteur,equipement.id_equipement,emprunt.statut_emprunt,emprunt.etat_equipement,emprunt.date_emprunt,emprunt.date_retour  FROM emprunteur,emprunt,equipement WHERE id_emprunt =:id";
        $sql = $db->prepare($sql);
...
.liste{
    ...
    <div class="col md-5">
                    <label  class="form-label"> Matricule de l'emprunteur:</label>
                    ...
                    <div class="col md-5">
                    <label  class="form-label" > ID_equipement:</label>
